...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addFlowerForm.addEventListener('submit', function (e) {
        ...
        const flower_container = document.getElementById('flower_container');
        flower_container.appendChild(flowerItem);
...
console.log("Код виконується.");

// Після додавання квітки в контейнер
console.log("Квітка додана до контейнера.");
